...
class MagicardApplicationTests {
	...
	// PaymentInfo paymentInfo = paymentInfoRepo.findById(1).orElse(null);
	// PurposeItem purposeItem = purposeItemRepo.findById(1).orElse(null);
	...
	// String[] categoryList = {"인건비","사업장 임대료", "인테리어 비용", "차량유지비", "통신비", "활동비",
	// "출장비", "비품 구입비", "접대비", "기타"};
